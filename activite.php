...
<?php $title = "ACTIVITE" ?>
    ...
    <!--SECTION TRAINNING START-->
    <section class="container trainning">
    ...
    <!--SECTION TRAINNING END-->
    <!--SECTION ATELIER START-->
    <section class="atelier container mb-5">
        <h3 class="title-atelier text-center text-dark mb-0">LES ATELIERS PRESENTS DANS LE TRAINNING FONCTIONNEL</h3>
        <div class="card-deck">
            <div class="card">
                <img src="./images/geek.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h6 class="date text-dark text-center font-weight-bold">TRX CORE</h6>
                    <p class="card-text text-dark">Some quick example text to build on the card title and make up the
                        bulk of the card's content. Some quick example text to build on the card title and make up the
                        bulk of the card's content.
                    </p>
                    <p>
                    <span class="font-weight-bold">Durée: </span> 45 minutes</p>
                </div>
            </div>
            <div class="card">
                <img src="./images/geek.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h6 class="date text-dark text-center font-weight-bold">BOXE</h6>
                    <p class="card-text text-dark">Some quick example text to build on the card title and make up the
                        bulk of the card's content. Some quick example text to build on the card title and make up the
                        bulk of the card's content.
                    </p>
            ...
            <div class="card">
                <img src="./images/geek.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h6 class="date text-dark text-center font-weight-bold">HIIT</h6>
                    <p class="card-text text-dark">Some quick example text to build on the card title and make up the
                        bulk of the card's content. Some quick example text to build on the card title and make up the
                        bulk of the card's content.
                    </p>
